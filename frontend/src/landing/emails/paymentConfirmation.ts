...
<head>
  ...
  <title>Payment Confirmed - LeadPilot</title>
</head>
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.07); overflow: hidden;">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 24px 0; font-size: 24px; font-weight: 600; color: #111827;">Payment Confirmed</h2>
              <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 1.6; color: #4b5563;">Hi {{userName}},</p>
              <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #4b5563;">Thank you for your payment! Your transaction has been processed successfully and your subscription is now active.</p>
                  ...
                  <td style="padding: 20px;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td style="padding: 8px 0; font-size: 14px; font-weight: 600; color: #111827; text-align: right;">{{currency}}{{amount}}</td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; font-size: 14px; color: #6b7280;">Transaction ID</td>
                        <td style="padding: 8px 0; font-size: 14px; font-weight: 600; color: #111827; text-align: right;">{{transactionId}}</td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; font-size: 14px; color: #6b7280;">Status</td>
                        <td style="padding: 8px 0; font-size: 14px; font-weight: 600; color: #059669; text-align: right;">✓ Completed</td>
                      </tr>
                    </table>
                  </td>
                </tr>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center" style="padding-bottom: 24px;">
                    <a href="{{loginUrl}}" style="display: inline-block; background-color: #d97706; color: #ffffff; text-decoration: none; font-size: 16px; font-weight: 600; padding: 14px 32px; border-radius: 8px;">Go to Dashboard</a>
                  </td>
                </tr>
              </table>
              <p style="margin: 0 0 8px 0; font-size: 14px; color: #6b7280; text-align: center;">
                <a href="{{invoiceUrl}}" style="color: #d97706; text-decoration: none;">View Invoice</a>
              </p>
            </td>
          </tr>
          <tr>
