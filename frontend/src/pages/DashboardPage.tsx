  ...
  return (
    <div className="mx-auto max-w-[1200px] space-y-8">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        />
        <StatCard title="Pipeline coverage" value="3 modes" hint="LinkedIn, Directory, and Explorer flows are available." />
      </section>
      ...
      <section className="rounded-2xl border border-surface-border bg-premium-card-light p-5 shadow-card dark:bg-premium-card-dark sm:p-6">
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-surface-border bg-field/40 px-4 py-3 text-sm text-ink-muted">
            <div className="text-xs font-semibold uppercase tracking-wide text-ink-subtle">Focus</div>
            <div className="mt-1 text-xl font-semibold capitalize text-ink">Leads and outcomes</div>
          </div>
        </div>
      </section>
    </div>
